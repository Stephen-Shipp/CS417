...
# ============================================
# Test Runner for Decimal to Binary Converter
# ============================================
...
show_help() {
    echo ""
    echo -e "${BLUE}========================================${NC}"
    echo -e "${BLUE}  Decimal to Binary Converter - Tests  ${NC}"
    echo -e "${BLUE}========================================${NC}"
    echo ""
...
run_specific() {
    ...
    echo "  2) TestTerminatingNumbers"
    echo "  3) TestRepeatingNumbers"
    echo "  4) TestAlgorithmDirectly"
    echo "  5) TestMaxDigitsRespected"
    echo "  6) TestMainFunction"
    echo ""
    read -p "Enter the number of the test class to run: " choice
    
    case $choice in
        1) class="TestSpecialCases" ;;
        2) class="TestTerminatingNumbers" ;;
        3) class="TestRepeatingNumbers" ;;
        4) class="TestAlgorithmDirectly" ;;
        5) class="TestMaxDigitsRespected" ;;
        6) class="TestMainFunction" ;;
        *)
